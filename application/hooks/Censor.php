...
/* 
 * Modifies four letter words to asterisks.
 */
...
class Censor
{
    ...
    /**
     * Takes in all the words in an HTML element. If they are four letters
     * in length, not counting punctuation, the letters will be replaced 
     * with asterisks.
     * 
